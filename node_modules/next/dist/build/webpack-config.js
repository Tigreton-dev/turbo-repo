...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =_constants1.COMPILER_NAMES.server , appDir , middlewareMatchers  }) {
                ...
                ...hasAppDir && !isClient && !isEdgeServer ? [
                    {
                        ...
                        resolve: {
                            ...
                            alias: {
                                ...
                                "react-dom$": isClient ? "next/dist/compiled/react-dom/index" : "next/dist/compiled/react-dom/server-rendering-stub",
                                "react-dom/client$": "next/dist/compiled/react-dom/client"
                            }
                        }
                    }, 
    ...
    const cache = {
        ...
        version: `${"12.3.2-canary.40"}|${configVars}`,
...
function isResourceInPackages(resource, packageNames, packageDirMapping) {
    return packageNames == null ? void 0 : packageNames.some((p)=>packageDirMapping && packageDirMapping.has(p) ? resource.startsWith(packageDirMapping.get(p) + _path.default.sep) : resource.includes(_path.default.sep + (0, _path).join("node_modules", p.replace(/\//g, _path.default.sep)) + _path.default.sep));
}
