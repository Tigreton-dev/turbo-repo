...
class FlightClientEntryPlugin {
     ...
     */ const visitedBySegment = {};
        ...
        const filterClientComponents = (dependencyToFilter, inClientComponentBoundary)=>{
            ...
            const modRequest = isLocal ? rawRequest // compilation.chunkGraph.getModuleId(mod) + ''
             : ((ref = mod.resourceResolveData) == null ? void 0 : ref.path) + ((ref3 = mod.resourceResolveData) == null ? void 0 : ref3.query);
