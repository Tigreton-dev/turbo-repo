...
var _hotReloaderClient = _interop_require_default(require("./components/react-dev-overlay/hot-reloader-client"));
...
function hydrate() {
    if (process.env.NODE_ENV !== 'production') {
        ...
        if (rootLayoutMissingTagsError) {
            ...
            }, /*#__PURE__*/ _react.default.createElement(_hotReloaderClient.default, {
                assetPrefix: rootLayoutMissingTagsError.assetPrefix
            })));
            return;
        }
    }
    const reactEl = /*#__PURE__*/ _react.default.createElement(_react.default.StrictMode, null, /*#__PURE__*/ _react.default.createElement(_headManagerContext.HeadManagerContext.Provider, {
        value: {
            appDir: true
        }
    }, /*#__PURE__*/ _react.default.createElement(Root, null, /*#__PURE__*/ _react.default.createElement(RSCComponent, null))));
    const isError = document.documentElement.id === '__next_error__';
    const reactRoot = isError ? _client.default.createRoot(appElement) : _react.default.startTransition(()=>_client.default.hydrateRoot(appElement, reactEl));
    if (isError) {
